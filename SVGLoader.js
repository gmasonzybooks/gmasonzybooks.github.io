/*
Forked version of Three.js's  SVGLoader.js for use with FBDmaim.html
...
( function () {
	...
	class SVGLoader extends THREE.Loader {
		...
		load( text, onLoad, thickness){ //, onProgress, onError ) {

			const scope = this;
			if (!isNaN(thickness)) this.thickness=thickness;
			...
			// loader.load( url, function ( text ) {
				...
				try {
					...
					return onLoad( scope.parse( text ), scope.thickness );
